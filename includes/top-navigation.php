 ...
 <div class="container style='margin-top:-10px!important;'">
        <div class="row">
            <div class="col-12">
                <nav class="navbar navbar-expand-lg my-4 py-2 start-0 end-0 mx-1 bg-light">
                    <div class="container-fluid px-0">
                        <a class="navbar-brand font-weight-bolder ms-sm-3" href="./" rel="tooltip" title="Designed and Coded by samkimani" data-placement="bottom">
                            ...
                            <ul class="navbar-nav navbar-nav-hover ms-auto">
                                ...
                                <li class="nav-item dropdown dropdown-hover mx-2">
                                    <a class="nav-link ps-2 d-flex cursor-pointer align-items-center <?= $page == "products" ? "text-primary" : "" ?>" href="./?page=products" aria-expanded="false">
                                        <i class="material-icons opacity-6 me-2 text-md">widgets</i> Products
                                    </a>
                                </li>
                                <li class="nav-item dropdown dropdown-hover mx-2">
